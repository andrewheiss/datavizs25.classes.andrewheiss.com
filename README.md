...
graph LR
  ...
  subgraph Graph
    ...
    xfd57e058b4891a64(["copy_lotr_rotk"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    x6cd0dee42a24f288(["copy_essential_construction"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    x655f7c7d213bbcce(["copy_natural_earth"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    x9d77e3f40385c2cf(["copy_internet"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    xf6926cf0b9c2f0f1(["copy_hot_dogs"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    x52d1f77786fc35cf(["copy_lotr_fellowship"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    xb88368986d4aa1bf(["copy_2016_election"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    xe5925d8feb2e17dc(["copy_lotr_tt"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    xa020bc555d3d1acc(["copy_unemployment"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    xa33faeb3fa230864(["copy_space_dogs"]):::completed --> x5d6dea1a226f7537(["copy_data"]):::queued
    x3f2ab5e74cba5dde(["get_data_fred"]):::completed --> xa1de4aa623defc27(["data_fred"]):::queued
    x625986734a8fee6a(["get_data_geocoded"]):::completed --> x67ad2d1638cd80fd(["data_geocoded"]):::queued
    ...
    x8b6ad04e87e06888(["gutenberg_books"]):::completed --> xf07d1b5b90f78e03(["little_women_tagged"]):::queued
    ...
    x47e79497b1720795(["proj_03_exercise_files"]):::completed --> xe8f40a384a24d92b["proj_03_exercise"]:::queued
    ...
    x34d6c07a2097c551(["proj_08_exercise_files"]):::completed --> xfc98124ac899c2ef["proj_08_exercise"]:::queued
    xedc1399ac927335b(["proj_09_exercise_files"]):::completed --> xf65f56f52b519b9b["proj_09_exercise"]:::queued
    ...
    x72c2061ddedee791(["proj_14_exercise_files"]):::completed --> x3b8755299d9c32b9["proj_14_exercise"]:::queued
    x879bfa4b7de0e7a9(["proj_example_final_files"]):::completed --> x27d40e204f5ff80a["proj_example_final"]:::queued
    ...
    x8b6ad04e87e06888(["gutenberg_books"]):::completed --> x5fee94802c729361(["site"]):::queued
    ...
    x5001cb60de5aa7c8(["slide_rmd_01_slides_files"]):::completed --> x39a82da8b6fae6fa["slide_rmd_01_slides"]:::queued
    xdf57381c885cd00f(["slide_rmd_02_slides_files"]):::queued --> x4d45c10c788cbb1e["slide_rmd_02_slides"]:::queued
    x3ece8da1469c00db(["slide_rmd_03_slides_files"]):::completed --> x86cd11787895f0ce["slide_rmd_03_slides"]:::queued
    x782368ccd11fc50b(["slide_rmd_04_slides_files"]):::completed --> xa5456a9999ae2296["slide_rmd_04_slides"]:::queued
    x78de70e29b2b5fc4(["slide_rmd_05_slides_files"]):::queued --> x3dd54da269b2735f["slide_rmd_05_slides"]:::queued
    xce2cc9c53c42aad7(["slide_rmd_06_slides_files"]):::completed --> x4e2decec9e1779c4["slide_rmd_06_slides"]:::queued
    ...
    x0957c8c9732fa332(["slide_rmd_09_slides_files"]):::completed --> xdf5033dfd85e9b07["slide_rmd_09_slides"]:::queued
    ...
    xb03f1698e2debc94(["slide_rmd_12_slides_files"]):::completed --> xc1418dbce57ce8dc["slide_rmd_12_slides"]:::queued
    x11762edb9ae29fab(["slide_rmd_13_slides_files"]):::completed --> x5dee707e323d9bdb["slide_rmd_13_slides"]:::queued
    xb9d12f12d1b272aa(["slide_rmd_14_slides_files"]):::completed --> xa82e4c2714985d36["slide_rmd_14_slides"]:::queued
    ...
    x830adcacfab4076a(["deploy_script"]):::completed
  end
```
