...
date: "2025-06-19T00:16"
categories: [course details]
---

Hi everyone!

You'll notice that I just updated your grades for the first two exercises in iCollege. In general you're all doing great!
...
Before today, if you checked your grades on iCollege, you’d be failing even if you turned in everything and got 100% on everything. That’s because the denominator was 680 points—the total number of points you can get this semester. But that’s inaccurate—we've only done exercises 1 and 2, so if you got the maximum score on those, you'd have a 40/680, or a 6% F. That's not useful information! There’s no use including everything else in the denominator for now.
