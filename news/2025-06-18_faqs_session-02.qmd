---
title: "Session 2 FAQs"
date: "2025-06-18T20:26"
categories: [FAQs]
---
...
This is a tricky quirk of using Quarto. In Markdown, the `#` symbol is how you [create headings](/news/2025-06-18_cleaner-nicer-qmd-output.qmd#headings-that-aren't-headings), and you can combine them to create nested headings and subheadings:

``` default
# Task 1: Sessopm check-in
