...
You will lose 0.5 points per day for each day an exercise is late. This is designed to not be a huge penalty (3 days late = 18.5/20 points on an exercise/weekly check-in that gets a ✓), but instead is a commitment device to help you stay on schedule.
