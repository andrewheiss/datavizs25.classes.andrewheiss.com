...
1. Add your [weekly check-in](/assignment/weekly-check-in.qmd) to the appropriate place in the Quarto file. You can type directly in RStudio if you want (though there's no spell checker), or you can type it in Word or Google Docs and then paste it into RStudio.
